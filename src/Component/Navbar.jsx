...
const Navbar = () => {
  ...
  return (
    <div className='px-2 py-2 bg-dark' id='nav'>
        <div className="d-flex justify-content-around">
            ...
            <Link className='text-decoration-none text-white' href={currentUser?"/chat":'/login'}><i className="fa-regular fs-4 fa-paper-plane"></i></Link>
